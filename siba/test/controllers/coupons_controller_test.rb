...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { amount: @coupon.amount, expiry: @coupon.expiry, name: @coupon.name, one_use: @coupon.one_use } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { amount: @coupon.amount, expiry: @coupon.expiry, name: @coupon.name, one_use: @coupon.one_use } }
